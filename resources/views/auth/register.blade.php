        ...
        <div class="row">
          ...
          <form method="POST" action="{{ route('register') }}">
              ...
              <div class="card-body">
                ...
                <label class="control-label text-uppercase font-weight-bold" >Password Confirimation:</label>
                    <div class="input-group">
                        ...
                        <input type="password" id="password_confirmation" name="password_confirmation" class="form-control font-weight-bold" placeholder="Password">
                    </div>
                </div>
              ...
              <div class="card-footer text-center">
                <input type="submit" name="register" id="register" class="btn btn-neutral btn-round btn-lg" value="Register" />
              </div>
            </form>
          </div>
        </div>
