            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    <div class="card-body p-4">
                        <h4 class="text-center font-weight-bold">APPLICATION FOR DEPENDENT</h4>
                        <h6 class="text-center font-weight-bold mb-4">3 Steps to complete your application</h6>
                        <div class="row justify-content-center">

                            <div class="col-12 mx-4">
                                <div class="mx-12">
                                    <div class="row">
                                        <div id="step1Tab" class="col-sm-4 text-center bg-primary text-white " style="cursor: pointer;">
                                            <h3>1</h3>
                                            <h6>TELL US ABOUT YOU</h6>
                                        </div>
                                        <div id="step2Tab" class="col-sm-4 text-center " style="cursor: pointer;">
                                            <h3>2</h3>
                                            <h6>CHOOSE YOUR ACCOUNT</h6>
                                        </div>
                                        <div id="step3Tab" class="col-sm-4 text-center " style="cursor: pointer;">
                                            <h3>3</h3>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="membership_type" id="membership_type" class="select2 form-control" style="width: 100%">
                                                ...
                                                <option value="EXTENDED DEPENDENT">EXTENDED DEPENDENT</option>
                                            </select>
                                            <span class="invalid-feedback" role="alert">
...
<script>
    ...
    function memberData() {
        ...
        $.ajax({
            url: "/admin/membership/dependent/" + id + "/json",
            dataType: "json",
            beforeSend: function() {
                                                ...
                                                $.confirm({
                                                    ...
                                                    buttons: {
                                                        confirm: {
                                                            ...
                                                            keys: ['enter', 'shift'],
                                                            action: function() {
                                                                window.location = "/admin/membership/principal/" + data.referral_code + "?step=4";
                                                            }
                                                        },
